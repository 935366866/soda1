(function($)
{
    ...
    $(document).ready(function()
    {
        ...
        //"ajax" berrypage
        $('.grid-links-ajax').avia_berrypage_preview();
...
(function($)
{
	...
	$.fn.avia_berrypage_preview = function(passed_options)
	{
		var win  = $(window),
		the_body = $('body'),
		isMobile = $.avia_utilities.isMobile,
		defaults =
		{
			open_in:	'.berrypage-details-inner',
			easing:		'easeOutQuint',
			timing:		800,
		...
		{
			var container			= $(this),
				berrypage_id		= container.data('berrypage-id'),
				target_wrap			= $('.berrypage_preview_container[data-berrypage-id="' + berrypage_id + '"]'),
			...
			methods =
			{
				load_item: function(e)
				{
					...
					container.find('.active_berrypage_item').removeClass('active_berrypage_item');
					post_container.addClass('active_berrypage_item');
					loader.show();
				...
				ajax_get_contents: function(post_id, clickedIndex)
				{
					...
					content_retrieved[post_id] = $('#avia-tmpl-berrypage-preview-' + post_id.replace(/ID_/,"")).html();

					//this line is necessary to prevent w3 total cache from messing up the berrypage if inline js is compressed
				...
				{
					var showItem,
						activeID = container.find('.active_berrypage_item').data('ajax-id'),
