    ...
    $.fn.avia_iso_sort = function (options) {
        ...
        return this.each(function () {
            var the_body = $('body'),
                ...
                filter = parentContainer.find('.sort_width_container[data-berrypage-id="' + berrypage_id + '"]').find('#js_sort_items').css({
                    visibility: "visible",
                    opacity: 0
                }),
                links = filter.find('a'),
    ...
    $.AviaTooltip.prototype =
    {
        ...
        display_tooltip: function (e) {
            ...
            newTip.css({
                ...
                top: real_top - 10,
                left: real_left
            }).stop().animate({top: real_top, opacity: 1}, 200);
